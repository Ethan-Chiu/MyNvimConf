...
local function load_session_menu(opts)
  opts = opts or {}

  local options = {"Load", "Cancel"}
...
---@param opts table
local function projects_session(opts)
  opts = opts or {}

  pickers.new(opts, {
    prompt_title = "Recent Projects & Sessions",
...
return telescope.register_extension({
  exports = {
    projects_session = projects_session,
  },
})

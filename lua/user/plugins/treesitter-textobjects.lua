    ...
    require'nvim-treesitter.configs'.setup({
      textobjects = {
        ...
        swap = {
          enable = true,
          swap_next = {
            ["<leader>ma"] = { query = "@parameter.inner", desc = "Swap argument with the next" },
            ["<leader>mf"] = { query = "@function.outer", desc = "Swap function with next" },
          },
          swap_previous = {
            ["<leader>mA"] = { query = "@parameter.inner", desc = "Swap argument with the previous" },
            ["<leader>mF"] = { query = "@function.outer", desc = "Swap function with previous" },
          },
        },
        move = {
          enable = true,
